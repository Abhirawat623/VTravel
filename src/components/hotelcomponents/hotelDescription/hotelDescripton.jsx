      ...
      <div className="key-features text-s">
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center">
            <span class="checklist material-icons-outlined">apps</span>Dedicated
            Workspace
          </p>
        </div>
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center ">
            <span class="checklist material-icons-outlined">apps</span>
            Refundable
          </p>
        </div>
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center">
            <span class="checklist material-icons-outlined">apps</span>Great
            Location
          </p>
        </div>
        <p className="p d-flex align-center">
          <span class="checklist material-icons-outlined">apps</span>Free
        ...
        <div className="d-flex dir-row space-between text-s">
          <div className="whats-for">
            <span className="span d-flex align-center gap-s">
              <span class="checklist material-icons-outlined">checklist</span>
              Kitchen
            </span>
            <span className="span d-flex align-center gap-s">
              <span class="checklist material-icons-outlined">checklist</span>
